...
namespace Common
{
  public class WinFromWebservice
    {
        #region 根据指定的信息，调用远程WebService方法
        ///   <summary>   
        ...
        ///   </code>   
        ///   </example> 
        ///    table_SPCD = ((DataSet)Webservice.InvokeWebservice(url + "SPCD.asmx", "BuildShopService", "SPCD", "SelectSPCD", new object[] {})).Tables[0];
